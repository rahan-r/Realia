...
function AnimatedBeamWrapper() {
  ...
  return (
    <div ref={containerRef} className="relative h-[300px] w-full">
      <div
        ref={fromRef}
        className="absolute left-10 top-10 h-4 w-4 rounded-full bg-blue-500"
      />
      <div
        ref={toRef}
        className="absolute right-10 bottom-10 h-4 w-4 rounded-full bg-pink-500"
      />
      <AnimatedBeam
...
const features = [
  ...
  },
  {
    ...
    cta: "Learn more",
    className: "col-span-3 lg:col-span-2",
    background: <AnimatedBeamWrapper />,
  },
  {
    Icon: CalendarIcon,
    name: "Calendar",
