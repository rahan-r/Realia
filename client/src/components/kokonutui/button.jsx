...
// }
// The interface above is removed.
// In a pure JS/JSX project, you might use PropTypes for type checking at runtime (optional).
...
export default function Btn07({
    ...
    ...props
// }: Btn07Props) { // Type annotation removed
}) {
    const [isProcessing, setIsProcessing] = useState(false);
    const [isSuccess, setIsSuccess] = useState(null); // Type <boolean | null> removed
    ...
    async function handleClick() {
        ...
        // This ensures the button shows "Processing..." for at least `processDuration`
