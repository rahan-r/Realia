...
export default function AiChat() {
    return (
        (<div
            ...
            <div
                className="w-full p-4 flex flex-col items-center justify-center h-screen mx-auto">
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    ...
                    <h1
                        className="text-5xl md:text-6xl font-medium mb-4 tracking-tighter bg-clip-text bg-gradient-to-b from-black to-black/70 text-white">
                        Welcome Traveler
                    </h1>
